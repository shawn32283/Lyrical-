...
module.exports = { session: process.env.SESSION_ID || 'ezra',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/Fred1e/lyrical_MD',
    OWNER_NAME : process.env.OWNER_NAME || "lyr",
    NUMERO_OWNER : process.env.NUMERO_OWNER || "254112492898",  
    ...
    CAPTION : process.env.CAPTION || "✧⁠Lyrical_xmd✧",
